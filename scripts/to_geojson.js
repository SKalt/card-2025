...
for (let part of raw.split(/"POINT \(/).slice(1)) {
  ...
  const [lon, lat] = pre.split(" ") // https://learn.microsoft.com/en-us/bingmaps/v8-web-control/modules/well-known-text-module , https://macwright.com/lonlat/
  ...
  result.features.push({type: "Feature", "geometry": {type: "Point", coordinates: [lon, lat]}, properties: {name, description, tags}})
}
